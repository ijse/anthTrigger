angular.module('ansiToHtml', ['ngSanitize'])
    .factory('ansi2html', function() {
        var ansi_up,
            VERSION = "1.1.0",
    ...
    .directive('ansiHtml', function(ansi2html, $sce) {
        return {
            restrict: 'E',
            scope: {
                value: '='
            ...
            link: function(scope, elem, attrs) {
                ...
                scope.$watch('value', function(val) {
                    ...
                    valArr.forEach(function(t) {
                        result += '<p style="line-height:1em; margin: 0;">' +
                            ansi2html.ansi_to_html(t) + '</p>';
                    });
                    scope.txt = $sce.trustAsHtml(result)
                });
            }
        }
    });
